          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              ...
              <p className="mt-6 font-body text-lg leading-8 text-white">
                Register now and within a few click you can rent out your home. We’ll match you with
                a Superhost in your area, who’ll guide you from your first question to your first
