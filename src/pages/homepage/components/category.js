...
function Category() {
  return (
    <div className="mx-auto max-w-7xl px-2">
      ...
      <div className="lg:my-5 lg:grid lg:grid-cols-4 lg:grid-rows-[220px_minmax(200px,_1fr)_240px] lg:gap-5">
        {/* section one */}
        <div className="my-5 grid grid-cols-2 grid-rows-[100px_minmax(100px,_1fr)_100px] gap-5 md:grid-rows-[100px_minmax(100px,_1fr)_200px] lg:col-span-2 lg:my-0">
        ...
        {/* section two */}
        <div className="my-5 grid grid-rows-3 gap-5 lg:col-start-3 lg:row-span-2 lg:my-0">
        ...
        <div className="grid grid-cols-2 gap-5 lg:grid-cols-1">
          <div className="relative h-24 md:h-48 lg:h-[220px]">
            <img className="h-full w-full rounded-lg object-cover" src={FrenchImg} alt="cottage" />
