    ...
    return (
        <div className="mx-auto max-w-7xl px-5">
            <div className="my-5 flex gap-5">
                <Dashboard />
                <div className="w-full bg-white p-4 drop-shadow-md md:p-8">
                    {isError ? (
                                            ...
                                            <table className="w-full text-center text-sm text-black">
                                                <thead className="bg-lightgrey text-xs uppercase text-black">
                                                    <tr>
                                                        ...
                                                        <th
                                                            scope="col"
                                                            className="max-w-[140px] px-1 py-3 lg:px-6"
                                                        >
                                                            Name
                                                        </th>
                                                        <th
                                                            scope="col"
                                                            className="px-1 py-3 lg:px-6"
                                                        >
                                                            Guests
                                                        </th>
                                                        <th
                                                ...
                                                <tbody>
                                                    <tr className="bg-white font-body text-sm font-light text-black">
                                                        <th className="my-4 hidden h-24 w-24 sm:block">
                                                            <img
